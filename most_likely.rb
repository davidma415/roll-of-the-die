...
# This will find the value that matches the max value along with the k value of the highest percentage.
permutations.each {|k, v| puts "#{k} is the most likely to come up with a #{((v/36.to_f)*100).round}% chance" if v == permutations.values.max }
